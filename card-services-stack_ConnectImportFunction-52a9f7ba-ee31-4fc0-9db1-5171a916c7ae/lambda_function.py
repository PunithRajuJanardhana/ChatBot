...
#         InstanceId='5e7151d6-d5ff-4f7f-93f5-765fe29e9b63',
#         ContactFlowId='1d4a31a1-b3a8-4905-aab9-d6ee0b5c34bb'
#     )
#     print(response['ContactFlow']['Content'])
# get_contact_flow()
# import_contact_flow('90f34d8c-4115-4a2a-971d-0d3e9eff636c', 'acardbot00',
#     'arn:aws:lex:us-east-1:049982172265:bot-alias/LQ0GTLASMI/TSTALIASID',
#     'arn:aws:lex:us-east-1:049982172265:bot-alias/ZKFCRSQVIE/TSTALIASID',
#     'CardServicesBot', 'BankingUserAuthentication')
    ...
    try:
        ...
        if not instance_id:
            ...
            reason = "The contact flow is not created. \
                You can continue to work with the chatbot on Lex V2 console."
            response = {}
        ...
        reason = "The connect parameters are invalid. The contact flow is not \
            created. You can continue to work with the chatbot on Lex V2 console."
        response = {}
        response['ContactFlowDescription'] = reason
        print(reason)
        cfnresponse.send(
...
#     'ResourceProperties': {
#         'ConnectInstanceARN': '',
#         'BotName': 'CardServicesBot',
#         'BotAliasArn': 'arn:aws:lex:us-east-1:049982172265:bot-alias/LQ0GTLASMI/TSTALIASID',
#         'ContactName': 'acardbot00'
#     }
# }
#
# lambda_handler(eventobj, {})
